...
If Not Browser("Openbare Magento 2 demo").Page("Afrekenen - Magento").WebElement(" Transfer Mony").Exist  Then 
	...
	Reporter.ReportEvent micFail, "Bank Transfer Payment ", "Failed to connect to database: connection timeout.!"
	ExitTest("Error Failed to connect to database: connection timeout.")
