...
If Browser("Home - Advantage Bank").Page("New Transfer - Advantage").WebButton("Send").Exist Then @@ script infofile_;_ZIP::ssf4.xml_;_
Reporter.ReportEvent micPass, " login live", "  login live passed  !"
else
	Reporter.ReportEvent micFail, " Login live ", " user has no access" 
	ExitTest("Test failed due to expired test credentials")
End If
