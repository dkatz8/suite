...
Browser("Home - Advantage Bank_2").Navigate "https://aadvantageonlinebanking.com/"
...
Reporter.ReportEvent micPass, "AOB live", " login passed !"
else
	Reporter.ReportEvent micFail, "AOB login live ", " Login failed " 
	ExitTest("Unexpected response code: 403 - Forbidden (user has no access).")
End If
